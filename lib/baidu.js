...
Baidu.prototype.init = function(callback) {
  ...
  if (this.session.accessToken) {
    ...
    this.quota(function(err, result, resp) {
...
Baidu.prototype.quota = function(callback) {
  ...
  request(quotaUrl, responseCallback(false, function(err, resp, body) {
    callback(null, JSON.parse(body), resp);
  }));
};
...
Baidu.prototype.list = function(callback) {
  ...
  request(listUrl, responseCallback('list', function(err, resp, body) {
